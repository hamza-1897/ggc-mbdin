...
function Principle() {
  return (
    <>
      <div id='container' className='flex flex-col  w-full h-[95vh] my-10 gap-8 md:h-[60vh]  md:my-3 md:p-2'>
<div > 
    <h1 className='text-center text-green-700 text-2xl font-serif underline font-bold'>Message From Principal</h1>
</div>
     <div className='flex flex-col md:flex-row h-auto justify-center   md:w-full mt-4 md:my-0 p-5 items-center'>
     <div id='image' className='flex flex-col justify-center  items-center h-[20%] md:h-full w-[40%]'>
        ...
        <div id='message' className='md:w-[60%] w-[90%] mt-14 px-3 md:my-0 py-1 h-[50%] md:h-[80%] border-x-4 border-green-700 md:px-3 md:py-6'>
